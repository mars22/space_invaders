defmodule SpaceInvaders.GameSupervisor do
  @moduledoc """
  ...
  alias SpaceInvaders.GameServer
  ...
  """
  def start_game(game_name, parent_pid) do
    child_spec = %{
      id: GameServer,
      start: {GameServer, :start_link, [game_name, parent_pid]},
      restart: :transient
    }
